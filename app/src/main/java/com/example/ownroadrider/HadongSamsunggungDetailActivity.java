        ...
        route_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (list == null || list.isEmpty()) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("nmap://navigation?dlat=35.2409&dlng=127.7013&dname=%ec%82%bc%ec%84%b1%ea%b6%81&appname=com.example.ownroadrider")));
                } else {
                    startActivity(intent);
                }
            }
