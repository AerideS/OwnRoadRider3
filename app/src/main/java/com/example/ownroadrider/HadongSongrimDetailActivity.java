...
public class HadongSongrimDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hadong_songrim_detail);
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HadongSongrimDetailActivity.this, Map_view.class);
                startActivity(intent);
            }
        });
        //마이페이지
        ...
        mypageButton_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(HadongSongrimDetailActivity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
        ...
        //Adapter
        pagerAdapter = new Image_Slider_Hadong_Songrim(this, num_page);
