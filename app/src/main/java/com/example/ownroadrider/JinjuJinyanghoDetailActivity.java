...
public class JinjuJinyanghoDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jinju_jinyangho_detail);
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(JinjuJinyanghoDetailActivity.this, Map_view.class);
                startActivity(intent);
            }
        });
        ...
        mypageButton_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(JinjuJinyanghoDetailActivity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
        ...
        //Adapter
        pagerAdapter = new Image_Slider_Jinju_Jinyangho(this, num_page);
