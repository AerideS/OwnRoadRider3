...
public class HamanIpgokDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.haman_ipgok_detail);
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HamanIpgokDetailActivity.this, Map_view.class);
                startActivity(intent);
            }
        });
        ...
        mypageButton_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(HamanIpgokDetailActivity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
        ...
        //Adapter
        pagerAdapter = new Image_Slider_Haman_Ipgok(this, num_page);
