...
public class GeojeWindDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.geoje_wind_detail);
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GeojeWindDetailActivity.this, Map_view.class);
                startActivity(intent);
            }
        });
        ...
        mypageButton_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(GeojeWindDetailActivity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
        ...
        //Adapter
        pagerAdapter = new Image_Slider_Geoje_Wind(this, num_page);
