...
public class GeochangSuseungDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(GeochangSuseungDetailActivity.this, Map_view.class);
                startActivity(intent);
            }
        });
        ...
        mypageButton_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(GeochangSuseungDetailActivity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
