...
public class HapcheonHaeinsaDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hapcheon_haeinsa_detail);
        ...
        mapButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HapcheonHaeinsaDetailActivity.this, Map_view.class);
                startActivity(intent);
            }
        });
        ...
        mypageButton_m.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(HapcheonHaeinsaDetailActivity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
        ...
        route_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (list == null || list.isEmpty()) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("nmap://navigation?dlat=35.8006&dlng=128.0974&dname=%ed%95%b4%ec%9d%b8%ec%82%ac%0d%0a&appname=com.example.ownroadrider")));
                } else {
                    startActivity(intent);
                }
            }
        ...
        //Adapter
        pagerAdapter = new Image_Slider_Hapcheon_Haeinsa(this, num_page);
